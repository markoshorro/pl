...
{
  "$end", "error", "$undefined", "INTEGER", "DOUBLE", "GRADE", "NAME",
  "STRING", "NIF", "SUBJECT", "YEAR", "$accept", "S", "line", "header",
  "tuple", YY_NULLPTR
};
#endif
...
#line 24 "parser.y" /* yacc.c:1646  */
    { /* increasing in one the number of line */}
...
#line 27 "parser.y" /* yacc.c:1646  */
    { printf("texto 1 rec: %s\ntexto 2 rec: %s\n", (yyvsp[-1].t_str), (yyvsp[0].t_str)); course = (yyvsp[-1].t_str); academic_year = (yyvsp[0].t_str); }
